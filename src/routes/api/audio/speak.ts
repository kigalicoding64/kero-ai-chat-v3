    ...
    handlers: {
      POST: async ({ request }) => {
        ...
        try {
          ...
          return errorResponse(400, "bad_request", "Invalid speak payload.");
        }
        ...
        try {
          ...
          if (!base64Audio) {
            return errorResponse(500, "tts_error", "No audio output was generated.");
          }
          ...
          return errorResponse(500, "tts_error", msg);
        }
      },
    },
  },
